    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('branch_code', models.PositiveIntegerField(blank=True, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('consignor_code', models.PositiveIntegerField(editable=False, null=True, unique=True, verbose_name='Consignor Code')),
                ...
                ('items', models.ManyToManyField(to='Adminapp.item')),
                ('state', models.ManyToManyField(to='Adminapp.location')),
            ],
            options={
